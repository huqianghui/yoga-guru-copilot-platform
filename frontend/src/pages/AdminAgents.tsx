    ...
    <div className="p-8 space-y-8">
      ...
      <InfoBox variant="tip" title="Agent 配置说明">
        <ul className="space-y-1">
          <li>
            - <strong>首选适配器</strong>: Agent 优先使用的 AI 后端 (Azure
            OpenAI / Claude / OpenAI)
          </li>
          <li>
            - <strong>备选适配器</strong>: 首选不可用时自动降级 (默认 mock)
          </li>
          <li>
            - <strong>System Prompt</strong>: 定义 Agent 的角色和行为边界
          </li>
          <li>
            - <strong>Skills</strong>: Agent 具备的能力标签 (目前为元数据)
          </li>
        </ul>
      </InfoBox>
    </div>
